...
@PermitAll
@Route(value = "job-info-invitation", layout = MainLayout.class)
public class JobInfoPageInvitation extends VerticalLayout implements HasUrlParameter<Long> {
    ...
    @Autowired
    public JobInfoPageInvitation(JobService jobSer, StudentResponseService studentRespService,
    ...
    public void createView(Long jobId) {
        ...
        moveBackButton = new Button("Назад", e -> getUI().get().navigate(InvitationsListView.class));
